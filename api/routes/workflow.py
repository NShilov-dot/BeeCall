...
async def validate_workflow(
    ...
    draft = await db_client.get_draft_version(workflow_id, organization_id=user.selected_organization_id)
    workflow_definition = (
...
async def get_workflows(
    ...
    run_counts = await db_client.get_workflow_run_counts(
        workflow_ids, organization_id=user.selected_organization_id
    )
...
async def update_workflow_status(
    ...
    try:
        ...
        run_count = await db_client.get_workflow_run_count(workflow.id, organization_id=user.selected_organization_id)
        return {
            "id": workflow.id,
            "name": workflow.name,
            "status": workflow.status,
    ...
    try:
        ...
        if workflow_definition:
            ...
            if existing_workflow:
                ...
                existing_draft = await db_client.get_draft_version(workflow_id, organization_id=user.selected_organization_id)
                existing_def = (
